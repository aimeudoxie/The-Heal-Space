...
// Query to get data
$sql = "SELECT user_id, fname, lname, email, age, occupation FROM users";
...
<div class="wrapper">
    ...
    <div class="container">
        ...
        NB: The users here are from the chatroom. The action for delete can only be performed when the user breaks the rules and regulations of the chatroom.
       </p>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo '<td><button class="btn btn-danger deleteBtn" data-id="' . $row["user_id"] . '">Delete</button></td>';
                    echo "</tr>";
                }
            } else {
